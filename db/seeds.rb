...
User.destroy_all
user1 = User.create!({ username: 'USERNAME',password: 'PASSWORD' ,img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522954985/anchor.png"})
user2 = User.create!({ username: 'BoatLover',password: 'PASSWORD', img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522957073/anchor2.jpg" })
user3 = User.create!({ username: 'Knotsar3C00l',password: 'PASSWORD', img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522957185/seahorse.jpg" })
user4 = User.create!({ username: 'LandLubber',password: 'PASSWORD', img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522957236/crab.jpg" })
user5 = User.create!({ username: 'BIRDS!',password: 'PASSWORD', img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522957293/whale.jpg"})
user6 = User.create!({ username: 'poseidon#1',password: 'PASSWORD', img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522957461/Poseidon_2.jpg" })
...
item1 = Item.create!({ title: 'Knotted Knot',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522885318/majorknot.jpg" })
item2 = Item.create!({ title: 'Solid Gold Boat',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522878283/Broighter_Gold_2C_Dublin_2C_October_2010__2803_29.jpg" })
item3 = Item.create!({ title: 'Wooden Boat',
  description: 'Pretty good boat! +2 speed.', price: 100, user_id: user3.id,
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522885461/wood_boat.jpg" })
...
item6 = Item.create!({ title: 'The Pacific Ocean',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522885988/pacific.jpg" })
...
item10 = Item.create!({ title: 'Broken Compass',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522887179/valve-2971385_960_720_2.jpg" })
...
item13 = Item.create!({ title: 'This Compass Works!',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522957865/wcompass.jpg" })
item14 = Item.create!({ title: 'Map to Everywhere!',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522959427/globe.png" })
item15 = Item.create!({ title: 'Unsinkable Boat',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522959477/Titanic_modelo_cropped.jpg" })
item16 = Item.create!({ title: 'Large Knot',
  description: 'Put this is any room for a more nautical feel.', price: 300, user_id: user4.id,
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522959526/bigknot.jpg" })
item17 = Item.create!({ title: 'Tiny Compass',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522959649/compass.png" })
item18 = Item.create!({ title: 'Large Boat',
  ...
  img_url:"http://res.cloudinary.com/dkaolr6pg/image/upload/c_scale,h_600,w_600/v1522959695/largeboat.jpg" })
